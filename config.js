...
const GAME_CONFIG = {
  ...
  levels: {
    ...
    5: {
      ...
      starThresholds: [75, 150, 300], // thresholds for 1, 2, 3 stars
      initialBatter: 6,
      initialMoney: 0,
      batterCost: 5,
